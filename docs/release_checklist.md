...
- [x] 연속 3회 동일 결과 — flaky 없음 (2026-08-17 재확인 — 과거엔 두 건 있었다:
  `observed_at` 이 시계에 걸린 것 → `docs/reports/debugs/2026-08-14_시계에_걸린_테스트가_가끔_실패한다.md`,
  동시 apply 테스트의 payload 설계 결함 → `docs/reports/debugs/2026-08-17_동시_apply_테스트가_flaky했다.md`)
...
- [x] ★**`unknown` 을 사람이 푸는 운영 절차(화면·런북)** — 2026-08-17 완료.
      ...
      + `docs/manuals/2026-08-17_unknown_처리_런북.md`. 계약 `docs/handoff/03` §1-6
