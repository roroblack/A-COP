...
| **Activity 범위** | **「여행지에서 하는 활동」 그 자체** — 관광공사 **A01 자연 · A02 인문 · A03 레포츠 · A04 쇼핑**. **예약 유무·실내 여부·레저 여부로 좁히지 않는다.** ★결제·환불 팀으로도, 레저 전용으로도 부르지 않는다(둘 다 실제로 잘못 불렸다). `[미확보]` 쇼핑 제외 목록 21종에 대형마트가 있어 재검토 필요 | `final_project_cs/wiki/teams/activity.md` | 2026-09-10 |
