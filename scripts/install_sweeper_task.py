...
★`final_project_cs` 에서 이식했다(2026-09-07). 작업 이름만 다르다 — **한 기계에
  두 대상이 걸릴 수 있으므로** 이름이 겹치면 한쪽이 다른 쪽을 덮어쓴다.
...
TASK_NAME = "A-COP sample sweeper"
...
def main() -> int:
    ...
    print("  (`wiki/operations/stuck-case-sweeper.md`)")
    return 0
