...
`[미확보]` **29건 중 7건만 확인했다.** 나머지 22건은 아직 안 봤다. 7번째(DoD-06)는 근거가 낡은 게 아니라 **처음부터 sample 을 잰 것**이었다 → [dod-evidence-drift.md](../../final_project_cs/wiki/quality/dod-evidence-drift.md)
