# -*- coding: utf-8 -*-
"""그림 19장을 base64 로 박아 넣은 HTML 한 장을 만든다.
...
SHEETS = [
    ...
    ("16_", "이 흐름이 실제로 만드는 것",
     "앞 장들의 JSON 은 HTTP 몸통이거나 메모리 위의 객체다. 새로 생기는 파일은 없고 전부 DB 행이다. "
     "칼럼 이름은 001_schema.sql 그대로다."),
    ("17_", "그럼 파일은 어디서 생기나",
     "실제로 있는 파일 이름만 적었다. 이 케이스가 읽는 것, Composer 가 쓰는 것, 평가가 만드는 것으로 나눴다."),
]
