...
# ---------------------------------------------------------------- 3.2 데이터 양
d.replace_para("00000073", ["쿠팡 주문 9행, 배송 이력 4행. 네이버 주문 72건 중 68건 수집. "
                            "택배 조회 58건 질의. VOC 공개 데이터 약 681MB."])
d.replace_para("00000075", ["쿠팡 고유 주문 8건. 배송 이력이 실제로 나온 것 13건. "
                            "취소된 배송 상자 3건과 송장번호 없는 상자 1건은 제외했다."])
...
CHANGES = [
    ...
    ("2026-08-28", "A-COPilot", "네이버 4건 누락과 택배 이력 13건을 그대로 기록", "숨기지 않는다"),
]
