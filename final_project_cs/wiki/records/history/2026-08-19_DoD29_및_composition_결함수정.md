...
- 수행: 사실수집 과정에서 `app/composition.py::_instantiate_team()` 이
  ...
  파라미터 이름으로 분기하도록 수정. `wiki/records/evidence/DoD-29_ResponseGenerationReview.md`
...
- 리포트: `wiki/records/reports/debugs/2026-08-19_composition_단일인자_Team_llm_오배선.md`,
  `wiki/records/reports/2026-08-19_DoD29-사실수집.md`, `wiki/records/evidence/DoD-29_ResponseGenerationReview.md`
