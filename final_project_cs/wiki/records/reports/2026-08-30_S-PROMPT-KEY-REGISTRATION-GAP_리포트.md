...
DoD-28 파인튜닝 모델의 RAG 통합 경로를 설계하던 중(`wiki/records/plans/2026-08-30_DoD28-FT-RAG통합_설계.md`),
...
레거시 격리 작업(order_shipping/return_exchange 프롬프트 제거, `wiki/records/handoff/_prompts/S-LEGACY-ISOLATE-ORDER-RETURN-TEAMS.md`)
