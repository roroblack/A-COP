...
- 재측정: 2026-08-14 · 실측 원문 `wiki/records/evidence/_raw/DoD-11_v3.md`
...
★계약 문서에도 이렇게 적어 두었다(`wiki/records/handoff/01_계약_Pydantic.md` §5):
...
1. **idempotency 필드 경계 충돌**. `app/core/idempotency.py`가 여러
   ...
   상세: `wiki/records/reports/2026-08-24_S-BASEMENT-03-TENANT-DEDUPE_리포트.md`
2. **MCP `open_support_case` 멱등성**. MCP 요청 ID 기반으로 REST와 동일한
   ...
   확인. 상세: `wiki/records/reports/2026-08-24_S-BASEMENT-01-AUTH-CONTRACT_리포트.md`
3. **`unknown` 사람 해결 화면·런북이 없던 갭을 메웠다.** `POST
   ...
   `wiki/records/reports/2026-08-24_S-BASEMENT-05-OUTBOX-RESOLUTION_리포트.md`,
   `wiki/records/manuals/운영_unknown상태_대응절차.md`
