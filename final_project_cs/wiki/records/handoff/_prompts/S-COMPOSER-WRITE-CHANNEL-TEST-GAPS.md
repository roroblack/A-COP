...
(`wiki/records/reports/2026-08-18_S-COMPOSER-WRITE-CHANNEL-PORT_리포트.md`).
계약(`final_project_sample/wiki/records/handoff/13_Composer_쓰기채널_계약.md` "테스트 계약" 절)이
...
`wiki/records/reports/2026-08-18_S-COMPOSER-WRITE-CHANNEL-TEST-GAPS_리포트.md`
