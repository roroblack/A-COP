...
- `wiki/records/reports/2026-08-24_S-PII-NAME-GAP-MEASURE_리포트.md` — 실측 결과:
...
- `final_project_cs/wiki/records/reports/2026-08-24_S-PII-NAME-DETECTOR-IMPLEMENT_리포트.md` (신규)
