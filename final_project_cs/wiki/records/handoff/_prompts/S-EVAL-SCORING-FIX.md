...
쓰기 대상:
  ...
  wiki/records/evidence/DoD-15*.md          (판정 갱신)
...
`wiki/records/evidence/DoD-15*.md` 를 재측정 결과로 갱신한다.
...
- [ ] `wiki/records/evidence/DoD-15*.md` 판정이 갱신됐다
...
`wiki/records/reports/2026-08-XX_S-EVAL-SCORING-FIX_리포트.md` 하나.
