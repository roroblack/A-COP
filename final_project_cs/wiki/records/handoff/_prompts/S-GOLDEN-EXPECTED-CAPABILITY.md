...
- `wiki/records/reports/2026-08-20_golden데이터셋_재작업_codex논의.md` — 이 작업의
...
- 검증 스크립트(위치는 `eval/` 아래 기존 관례를 따르되, 일회성이면
  `wiki/records/reports/` 옆에 결과만 남기고 스크립트는 리포트에 인라인으로
  붙여도 된다 — 판단해서 정해라)
- `wiki/records/reports/2026-08-20_S-GOLDEN-EXPECTED-CAPABILITY_리포트.md` (신규)
