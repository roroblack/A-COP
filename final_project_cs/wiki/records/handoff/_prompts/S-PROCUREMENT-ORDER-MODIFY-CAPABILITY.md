...
- `wiki/records/reports/2026-08-24_S-GOLDEN-CAPABILITY-REAUDIT_리포트.md` — golden
...
- `wiki/records/reports/2026-08-24_S-PROCUREMENT-ORDER-MODIFY-CAPABILITY_리포트.md` (신규)
