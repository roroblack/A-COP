...
`wiki/records/evidence/DoD-28_파인튜닝_방어지표.md`가 기록한 대로,
...
- `wiki/records/reports/2026-08-28_S-DOD28-GOLDEN-DEFENSE-METRICS_리포트.md`에
...
- `wiki/records/reports/2026-08-28_S-DOD28-GOLDEN-DEFENSE-METRICS_리포트.md` (신규)
...
- 파인튜닝(1차/2차 모델)은 이 계약 범위가 아니다 — 지표를 먼저
  만드는 게 이 계약의 목적이다(`wiki/records/evidence/DoD-28...md`의 "선행
  관계" 표 그대로).
