...
- `wiki/records/reports/2026-08-29_S-AUDIT-STORE_리포트.md`
...
조립하는 근거가 아니다. 따라서 `wiki/records/handoff/13`의 기본 필드와 `/changes`
...
- `wiki/records/handoff/13_Composer_쓰기채널_계약.md`
- `CLAUDE.md` §0.3
