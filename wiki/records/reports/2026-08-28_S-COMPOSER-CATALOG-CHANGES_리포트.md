...
실행일: 2026-08-28. 계획서: `wiki/records/plans/2026-08-28_선언형Team_카탈로그CRUD_계획.md`.
...
(`wiki/records/handoff/13` v2 가 registry allowlist 를 둔 것과 같은 이유).
...
`wiki/records/handoff/13` 의 기존 지침이 그대로 적용된다.
