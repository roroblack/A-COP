...
- `wiki/records/reports/2026-08-19_S-SCAFFOLD-CLI-01_리포트.md`

## 고친 파일

- `wiki/records/handoff/10_도메인_교체_가이드.md`
- `wiki/records/vision/TODO_VISION.md`
- `wiki/records/vision/VISION-10_예제_카탈로그_스캐폴딩_CLI.md`
