...
`wiki/records/vision/VISION-10_예제_카탈로그_스캐폴딩_CLI.md`의 1층(카탈로그+CLI)을
실행한다. 실행계획서는 `wiki/records/plans/2026-08-19_예제_카탈로그_스캐폴딩_CLI_1층_계획.md`
...
4. **`wiki/records/handoff/10_도메인_교체_가이드.md`** §3("새 프로젝트 준비 —
...
5. **`wiki/records/vision/TODO_VISION.md`** — VISION-10 행의 상태를 "보류" →
...
`wiki/records/reports/2026-08-19_S-SCAFFOLD-CLI-01_리포트.md` — 실행 명령과 실제
