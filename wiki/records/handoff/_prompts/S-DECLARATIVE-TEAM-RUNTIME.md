...
계획서는 `wiki/records/plans/2026-08-28_선언형Team_카탈로그CRUD_계획.md`다. 이 계약은
...
(`wiki/records/handoff/10_도메인_교체_가이드.md` §0,
...
`wiki/records/reports/2026-08-28_S-DECLARATIVE-TEAM-RUNTIME_리포트.md` — 만든/고친
