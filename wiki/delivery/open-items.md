...
| # | 무엇이 어긋나나 | 어느 쪽이 맞나 |
|---|---|---|
| ~~1~~ | ~~v11 §0-2A 가 DoD 를 24 라 적는데 §12 는 25~~ | **닫힘 (2026-09-10).** 계획 세션이 고쳤고 지금 **둘 다 26**이다 — DoD 가 그 사이 또 하나 늘었다(26 안내 중복 0) |
| ~~2~~ | ~~v11 §0-4 가 「결정 여덟」이라 적는데 표에는 1~9 가 있다~~ | **닫힘 (2026-09-10).** 계획 세션이 「**팀장 결정 열둘**」로 고쳤고 표도 12행이다 — 그 사이 결정이 셋 더 늘었다(10~12) |
