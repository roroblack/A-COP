...
**"29개 전부 evidence로 평가됨"이 "코드가 전부 검증됨"은 아니다.** DoD는 계획서가 요구한 것의 목록이지 결함 전체의 목록이 아니다. 이런 수정은 리포트로만 남는다 — `final_project_cs/wiki/records/reports/2026-08-24_S-BASEMENT-09-*`, `-10-*`.
